...
const Card = async ({ event, hasOrderLink, hidePrice }) => {
  ...
  return (
    <div
      ...
      className="bg-white relative border flex-shrink-0 border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 max-w-lg"
    >
      {/* Event Image */}
      ...
      <div className="p-6">
        ...
        <div className="flex justify-start gap-4 items-center">
          <button className="bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 px-8 rounded-full font-medium hover:opacity-90 transition-opacity">
            Book Now
          </button>
        </div>
      </div>
