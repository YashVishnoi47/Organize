  ...
  return (
    <div className="w-full relative flex justify-center h-20">
      ...
      <div className="right p-4 w-[40%] items-center gap-8 justify-end h-full  flex">
        <SignedOut>
          <SignInButton className="cursor-pointer hidden lg:flex flex-shrink-0 transition-all rounded-full py-2 bg-purple-500 text-white px-6 py-rounded-lg border-purple-900 border-b-[4px] hover:brightness-110 hover:-translate-y-[1px]  active:border-b-[2px] active:brightness-90 active:translate-y-[2px] md:w-auto md:px-8 md:py-3" />
          <SignUpButton className="cursor-pointer hidden lg:flex flex-shrink-0 transition-all rounded-full py-2 bg-purple-500 text-white px-6 py-rounded-lg border-purple-900 border-b-[4px] hover:brightness-110 hover:-translate-y-[1px]  active:border-b-[2px] active:brightness-90 active:translate-y-[2px] md:w-auto md:px-8 md:py-3" />
          ...
          <Sheet>
            ...
            <SheetContent className="w-full max-w-[280px] bg-white shadow-lg rounded-l-xl p-6 flex flex-col gap-6">
              ...
              <nav className="flex flex-col gap-4">
                <SignInButton className="flex items-center gap-3 p-3 text-lg font-medium text-gray-700 hover:text-purple-600 hover:bg-purple-100 rounded-lg transition-all duration-300" />
                <SignUpButton className="flex items-center gap-3 p-3 text-lg font-medium text-gray-700 hover:text-purple-600 hover:bg-purple-100 rounded-lg transition-all duration-300" />
              </nav>
